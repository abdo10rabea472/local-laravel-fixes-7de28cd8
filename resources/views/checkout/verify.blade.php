...
<div class="mx-auto max-w-2xl rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
    ...
    @endif
    <a href="{{ route('home') }}" class="mt-6 inline-flex h-11 items-center rounded-xl bg-sky-600 px-5 text-sm font-bold text-white transition-colors hover:bg-sky-700">العودة للرئيسية</a>
</div>
</div>
@endsection
