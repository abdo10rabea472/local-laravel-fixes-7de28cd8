<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <div class="space-y-3 p-4 bg-slate-50 rounded-2xl border border-slate-100">
        <label class="text-xs font-bold text-slate-500">Site Logo</label>
    ...
    {{-- Hero Background --}}
    <div class="space-y-3 p-4 bg-slate-50 rounded-2xl border border-slate-100">
        <label class="text-xs font-bold text-slate-500">Homepage Hero Background</label>
    ...
    <div class="space-y-3 p-4 bg-slate-50 rounded-2xl border border-slate-100">
        <label class="text-xs font-bold text-slate-500">Default Product Image</label>
    ...
    {{-- Default OG Image --}}
    <div class="space-y-3 p-4 bg-slate-50 rounded-2xl border border-slate-100">
        <label class="text-xs font-bold text-slate-500">Default Open Graph Image</label>
