<div class="space-y-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="space-y-2">
            <label class="text-xs font-bold text-slate-500">اسم الموقع</label>
        ...
        <div class="space-y-2 md:col-span-2">
            <label class="text-xs font-bold text-slate-500">رسالة الترحيب</label>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="space-y-2 md:col-span-2">
                <label class="flex items-center gap-2 cursor-pointer">
                    ...
                    <span class="text-sm font-bold text-slate-700">تفعيل النافذة المنبثقة</span>
                </label>
            </div>

            <div class="space-y-2">
                <label class="text-xs font-bold text-slate-500">عنوان النافذة</label>
            ...
            <div class="space-y-2 md:col-span-2">
                <label class="text-xs font-bold text-slate-500">نص الرسالة</label>
            ...
            <div class="space-y-2 md:col-span-2">
                <label class="text-xs font-bold text-slate-500">صورة النافذة (اختياري)</label>
