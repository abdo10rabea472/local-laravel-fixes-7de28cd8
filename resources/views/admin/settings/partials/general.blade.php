<div class="space-y-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="space-y-2">
            <label class="text-xs font-bold text-slate-500">Site Name</label>
        ...
        <div class="space-y-2">
            <label class="text-xs font-bold text-slate-500">Primary Color</label>
        ...
        <div class="space-y-2 md:col-span-2">
            <label class="text-xs font-bold text-slate-500">Welcome Message</label>
    ...
    <div class="border-t border-slate-100 pt-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-2">
                <label class="text-xs font-bold text-slate-500">Popup Title</label>
            ...
            <div class="space-y-2">
                <label class="text-xs font-bold text-slate-500">Button Text</label>
            ...
            <div class="space-y-2">
                <label class="text-xs font-bold text-slate-500">Discount Code</label>
            ...
            <div class="space-y-2">
                <label class="text-xs font-bold text-slate-500">Discount Percent (%)</label>
            ...
            <div class="space-y-2 md:col-span-2">
                <label class="text-xs font-bold text-slate-500">Popup Image (optional)</label>
