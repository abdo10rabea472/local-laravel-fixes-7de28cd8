                ...
                @forelse($posts as $p)
                    <tr class="border-t border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-dark-800/50">
                        ...
                        <td class="p-3 text-center whitespace-nowrap">
                            ...
                            <form action="{{ route('admin.blog.destroy', $p) }}" method="POST" class="inline" data-confirm="{{ __('app.admin_blog_confirm_delete') }}" onsubmit="return confirm(this.dataset.confirm)">
                                @csrf @method('DELETE')
