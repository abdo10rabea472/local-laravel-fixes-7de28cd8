                ...
                @forelse($subscribers as $s)
                    <tr class="border-t border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-dark-800/50">
                        ...
                        <td class="p-3 text-center whitespace-nowrap">
                            ...
                            <form method="POST" action="{{ route('admin.subscribers.destroy', $s) }}" class="inline ml-2" data-confirm="{{ __('app.admin_subscribers_confirm_delete') }}" onsubmit="return confirm(this.dataset.confirm)">
                                @csrf @method('DELETE')
