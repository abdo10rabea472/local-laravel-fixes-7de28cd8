...
@php
    ...
    // bg-sky-50 bg-indigo-50 bg-emerald-50 bg-amber-50 bg-rose-50 bg-sky-50 bg-blue-50 bg-fuchsia-50 bg-teal-50 bg-orange-50
    // text-sky-700 text-indigo-700 text-emerald-700 text-amber-700 text-rose-700 text-sky-700 text-blue-700 text-fuchsia-700 text-teal-700 text-orange-700
    // bg-sky-100 bg-indigo-100 bg-emerald-100 bg-amber-100 bg-rose-100 bg-sky-100 bg-blue-100 bg-fuchsia-100 bg-teal-100 bg-orange-100
    // text-sky-600 text-indigo-600 text-emerald-600 text-amber-600 text-rose-600 text-sky-600 text-blue-600 text-fuchsia-600 text-teal-600 text-orange-600
@endphp

@section('content')
<section class="bg-gradient-to-br from-sky-600 via-sky-700 to-indigo-800 text-white py-20">
    <div class="max-w-6xl mx-auto px-4 text-center">
        <h1 class="text-4xl md:text-5xl font-bold mb-4">{{ $about['hero']['title'] }}</h1>
        <p class="text-lg text-sky-100 max-w-2xl mx-auto">{{ $about['hero']['subtitle'] }}</p>
    </div>
</section>
    ...
    <div class="max-w-6xl mx-auto px-4">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div class="text-center">
                <div class="w-32 h-32 mx-auto bg-gradient-to-br from-sky-500 to-indigo-600 rounded-full flex items-center justify-center text-white text-4xl font-bold mb-3 shadow-lg">
