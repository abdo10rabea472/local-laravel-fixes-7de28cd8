...
<header class="sticky top-0 z-50 w-full">
    ...
    <div class="bg-gradient-to-r from-sky-800 to-blue-600 text-white text-[11px] sm:text-xs">
            ...
            <div class="flex h-20 items-center justify-between gap-4 lg:gap-8">
                ...
                <a href="{{ route('home') }}" class="shrink-0 flex items-center gap-2.5 group">
                  <div class="logo-box w-70 h-10 flex items-center justify-center">
                    ...
                    @else
                        <span class="w-11 h-11 rounded-2xl bg-gradient-to-br from-blue-600 to-indigo-700 text-white grid place-items-center text-lg font-black shadow-lg shadow-blue-500/30 group-hover:scale-105 transition">
                ...
                <div class="hidden md:flex flex-1 max-w-2xl">
                    <form action="{{ route('products.index') }}" method="get" class="relative w-full group">
                        ...
                        <button type="submit" class="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-blue-600 transition-colors">
                ...
                <div class="flex items-center gap-1.5 sm:gap-2 shrink-0">
                    @if(auth()->guard('admin')->check())
                        <a href="{{ route('admin.dashboard') }}" class="hidden lg:inline-flex items-center gap-2 h-11 px-4 rounded-full text-xs font-bold text-white bg-gradient-to-r from-sky-800 to-blue-600 hover:opacity-90 transition shadow-md shadow-blue-500/30">
                    ...
                    @auth('web')
                        <div class="relative group hidden sm:block">
                            <button type="button" class="flex items-center gap-2 h-11 pl-1.5 pr-3 rounded-full bg-slate-50 hover:bg-blue-50 text-slate-700 transition-colors border border-slate-200">
                                <span class="w-8 h-8 rounded-full bg-gradient-to-br from-blue-600 to-indigo-600 text-white flex items-center justify-center text-xs font-black">{{ mb_substr(auth()->user()->name, 0, 1) }}</span>
                            ...
                            <div class="absolute right-0 top-full pt-2 z-50 hidden group-hover:block min-w-[240px]">
                                <div class="bg-white rounded-2xl shadow-2xl border border-slate-100 overflow-hidden p-2">
                                    ...
                                    <a href="{{ route('account.dashboard') }}" class="flex items-center gap-3 px-3 py-2 rounded-xl text-sm font-semibold text-slate-600 hover:bg-blue-50 hover:text-blue-700"><i class="fa-solid fa-gauge-high w-5 text-blue-500"></i> {{ __('app.nav_dashboard') }}</a>
                                    <a href="{{ route('account.orders') }}" class="flex items-center gap-3 px-3 py-2 rounded-xl text-sm font-semibold text-slate-600 hover:bg-blue-50 hover:text-blue-700"><i class="fa-solid fa-receipt w-5 text-blue-500"></i> {{ __('app.nav_my_orders') }}</a>
                                    <a href="{{ route('account.returns.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-xl text-sm font-semibold text-slate-600 hover:bg-blue-50 hover:text-blue-700"><i class="fa-solid fa-rotate-left w-5 text-blue-500"></i> {{ __('app.nav_returns') }}</a>
                                    <a href="{{ route('account.reviews') }}" class="flex items-center gap-3 px-3 py-2 rounded-xl text-sm font-semibold text-slate-600 hover:bg-blue-50 hover:text-blue-700"><i class="fa-solid fa-star w-5 text-blue-500"></i> {{ __('app.shared_reviews') }}</a>
                                    <a href="{{ route('wishlist.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-xl text-sm font-semibold text-slate-600 hover:bg-blue-50 hover:text-blue-700"><i class="fa-solid fa-heart w-5 text-rose-500"></i> {{ __('app.nav_wishlist') }}</a>
                                    <a href="{{ route('profile.edit') }}" class="flex items-center gap-3 px-3 py-2 rounded-xl text-sm font-semibold text-slate-600 hover:bg-blue-50 hover:text-blue-700"><i class="fa-solid fa-user-pen w-5 text-blue-500"></i> {{ __('app.nav_profile') }}</a>
                    ...
                    {{-- Cart --}}
                    <button type="button" onclick="open_close_cart()" class="relative flex items-center gap-2 h-11 px-3 sm:px-4 rounded-full bg-gradient-to-r from-sky-800 to-blue-600 hover:opacity-90 transition shadow-md shadow-blue-500/30 text-white">
                        <i class="fa-solid fa-cart-shopping text-base"></i>
                        <span class="hidden sm:inline text-sm font-bold">{{ __('app.shared_cart') }}</span>
                        <span id="cart-count" class="absolute -top-1 -right-1 h-5 min-w-[20px] px-1 flex items-center justify-center rounded-full text-[10px] font-bold text-blue-700 bg-amber-300 ring-2 ring-white">0</span>
                    </button>
        ...
        <div class="hidden lg:block border-t border-slate-100 bg-white">
            <div class="max-w-[1850px] mx-auto px-4 sm:px-6 lg:px-8">
                <nav class="flex flex-nowrap items-center gap-1 h-12 whitespace-nowrap">
                        ...
                        <div id="colleges-dropdown-panel"
                            ...
                            <div class="bg-white rounded-2xl shadow-2xl border border-slate-100 overflow-hidden">
                                <div class="bg-gradient-to-r from-blue-50 to-indigo-50 px-5 py-3 border-b border-slate-100">
                                    <div class="text-xs font-black uppercase tracking-wider text-blue-700">{{ __('app.nav_browse_by_college') }}</div>
                                </div>
                                <div class="max-h-[min(70vh,520px)] overflow-y-auto overscroll-contain p-4">
                                    <div class="grid grid-cols-1 xl:grid-cols-2 gap-3">
                                        @foreach($navCategories ?? [] as $college)
                                        <div class="rounded-xl border border-slate-100 p-3 hover:border-blue-300 hover:shadow-md transition {{ $currentCategorySlug === $college->slug ? 'border-blue-300 bg-blue-50/40' : '' }}">
                                            <a href="{{ route('category.show', $college->slug) }}" class="flex items-center gap-3 group/college">
                                                ...
                                                <div class="flex-1 min-w-0">
                                                    <div class="text-sm font-black text-slate-800 group-hover/college:text-blue-700 truncate">{{ $college->name }}</div>
                                                    <div class="text-[10px] text-slate-400 font-semibold">{{ $college->children_count }} {{ __('app.shared_departments') }}</div>
                                                </div>
                                                <i class="fa-solid fa-arrow-right text-[10px] text-slate-300 group-hover/college:text-blue-600 group-hover/college:translate-x-0.5 transition shrink-0"></i>
                                            </a>
                    ...
                    <a href="{{ route('home') }}" class="shrink-0 flex items-center gap-1.5 px-4 h-12 text-sm font-bold {{ request()->routeIs('home') ? 'text-blue-700 border-b-2 border-blue-600' : 'text-slate-600 hover:text-blue-700 border-b-2 border-transparent hover:border-blue-300' }} transition">
                        <i class="fa-solid fa-house text-xs"></i> {{ __('app.shared_home') }}
                    </a>
                    <a href="{{ route('products.index') }}" class="shrink-0 flex items-center gap-1.5 px-4 h-12 text-sm font-bold {{ request()->routeIs('products.*') ? 'text-blue-700 border-b-2 border-blue-600' : 'text-slate-600 hover:text-blue-700 border-b-2 border-transparent hover:border-blue-300' }} transition">
                    ...
                    <a href="{{ route('blog.index') }}" class="shrink-0 flex items-center gap-1.5 px-4 h-12 text-sm font-bold {{ request()->routeIs('blog.*') ? 'text-blue-700 border-b-2 border-blue-600' : 'text-slate-600 hover:text-blue-700 border-b-2 border-transparent hover:border-blue-300' }} transition">
                        <i class="fa-solid fa-newspaper text-xs"></i> {{ __('app.shared_blog') }}
                    </a>
                    <a href="{{ route('track-order') }}" class="shrink-0 flex items-center gap-1.5 px-4 h-12 text-sm font-bold {{ request()->routeIs('track-order') ? 'text-blue-700 border-b-2 border-blue-600' : 'text-slate-600 hover:text-blue-700 border-b-2 border-transparent hover:border-blue-300' }} transition">
                        <i class="fa-solid fa-truck text-xs"></i> {{ __('app.shared_track_order') }}
                    </a>
                    <a href="{{ route('contact') }}" class="shrink-0 flex items-center gap-1.5 px-4 h-12 text-sm font-bold {{ request()->routeIs('contact') ? 'text-blue-700 border-b-2 border-blue-600' : 'text-slate-600 hover:text-blue-700 border-b-2 border-transparent hover:border-blue-300' }} transition">
                        <i class="fa-solid fa-envelope text-xs"></i> {{ __('app.nav_contact') }}
                    </a>
                    <a href="{{ route('about') }}" class="hidden xl:flex items-center gap-1.5 px-4 h-12 text-sm font-bold {{ request()->routeIs('about') ? 'text-blue-700 border-b-2 border-blue-600' : 'text-slate-600 hover:text-blue-700 border-b-2 border-transparent hover:border-blue-300' }} transition">
                    ...
                    @foreach($navHeaderMenu ?? collect() as $item)
                        @if($item->children->isNotEmpty())
                            <div class="relative group shrink-0">
                                <button type="button" class="shrink-0 flex items-center gap-1.5 px-4 h-12 text-sm font-bold text-slate-600 hover:text-blue-700 border-b-2 border-transparent hover:border-blue-300 transition">
    ...
    <div id="site-mobile-menu" data-mobile-menu-panel class="lg:hidden hidden bg-white border-b border-slate-200 max-h-[85vh] overflow-y-auto shadow-lg">
        <div class="px-4 py-4 space-y-4">
            ...
            @if(auth()->guard('admin')->check())
                <a href="{{ route('admin.dashboard') }}" class="flex items-center justify-center gap-2 h-11 px-4 rounded-full text-xs font-bold text-white bg-gradient-to-r from-blue-600 to-indigo-600 hover:opacity-90 transition shadow-md shadow-blue-500/30">
                    <i class="fa-solid fa-user-shield"></i> {{ __("app.nav_admin_panel") }}
                </a>
            @endif
            ...
            @guest('web')
                ...
                <div class="grid grid-cols-2 gap-2">
                    ...
                    <a href="{{ route('register') }}" class="h-11 flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-sm font-bold shadow-md">
            ...
            @auth('web')
                <details class="group rounded-2xl border border-slate-100 bg-white overflow-hidden">
                    <summary class="flex items-center gap-3 px-3 py-3 cursor-pointer list-none hover:bg-slate-50">
                        <span class="w-10 h-10 rounded-full bg-gradient-to-br from-blue-600 to-indigo-600 text-white flex items-center justify-center text-sm font-black shrink-0">{{ mb_substr(auth()->user()->name, 0, 1) }}</span>
                    ...
                    <div class="p-2 space-y-1 border-t border-slate-100 bg-slate-50/50">
                        <a href="{{ route('account.dashboard') }}" class="flex items-center gap-3 px-3 py-2 rounded-xl text-sm font-semibold text-slate-600 hover:bg-white hover:text-blue-700"><i class="fa-solid fa-gauge-high w-5 text-blue-500"></i> {{ __('app.nav_dashboard') }}</a>
                        <a href="{{ route('account.orders') }}" class="flex items-center gap-3 px-3 py-2 rounded-xl text-sm font-semibold text-slate-600 hover:bg-white hover:text-blue-700"><i class="fa-solid fa-receipt w-5 text-blue-500"></i> {{ __('app.nav_my_orders') }}</a>
                        <a href="{{ route('account.returns.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-xl text-sm font-semibold text-slate-600 hover:bg-white hover:text-blue-700"><i class="fa-solid fa-rotate-left w-5 text-blue-500"></i> {{ __('app.nav_returns') }}</a>
                        <a href="{{ route('account.reviews') }}" class="flex items-center gap-3 px-3 py-2 rounded-xl text-sm font-semibold text-slate-600 hover:bg-white hover:text-blue-700"><i class="fa-solid fa-star w-5 text-blue-500"></i> {{ __('app.shared_reviews') }}</a>
                        <a href="{{ route('wishlist.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-xl text-sm font-semibold text-slate-600 hover:bg-white hover:text-blue-700"><i class="fa-solid fa-heart w-5 text-rose-500"></i> {{ __('app.nav_wishlist') }}</a>
                        <a href="{{ route('profile.edit') }}" class="flex items-center gap-3 px-3 py-2 rounded-xl text-sm font-semibold text-slate-600 hover:bg-white hover:text-blue-700"><i class="fa-solid fa-user-pen w-5 text-blue-500"></i> {{ __('app.nav_profile') }}</a>
                        <form method="POST" action="{{ route('logout') }}" class="border-t border-slate-100 mt-1 pt-1">@csrf
                            <button class="w-full flex items-center gap-3 px-3 py-2 rounded-xl text-sm font-semibold text-rose-600 hover:bg-rose-50 text-right"><i class="fa-solid fa-arrow-right-from-bracket w-5"></i> {{ __('app.nav_logout') }}</button>
                        </form>
                    </div>
