...
<article class="group flex flex-col rounded-xl bg-white border border-slate-200/80 overflow-hidden hover:shadow-md hover:-translate-y-0.5 hover:border-violet-300 transition-all duration-200" data-id="{{ $product->id }}">
